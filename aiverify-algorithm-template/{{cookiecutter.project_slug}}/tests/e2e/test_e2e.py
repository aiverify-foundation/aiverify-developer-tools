...
regression_non_pipeline = {
    "data_path": str("https://github.com/aiverify-foundation/aiverify/raw/refs/heads/main/stock-plugins/user_defined_files/data/sample_reg_donation_data.sav"),
    "model_path": str(
    ...
    "ground_truth_path": str("https://github.com/aiverify-foundation/aiverify/raw/refs/heads/main/stock-plugins/user_defined_files/data/sample_reg_donation_data.sav"),
    "run_pipeline": False,
...
binary_classification_pipeline = {
    "data_path": str(
        "https://github.com/aiverify-foundation/aiverify/raw/refs/heads/main/stock-plugins/user_defined_files/data/sample_bc_pipeline_credit_data.sav"
    ),
    ...
    "ground_truth_path": str(
        "https://github.com/aiverify-foundation/aiverify/raw/refs/heads/main/stock-plugins/user_defined_files/data/sample_bc_pipeline_credit_ytest_data.sav"
    ),
    "run_pipeline": False,
