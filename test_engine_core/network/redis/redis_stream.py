...
class RedisStream(RedisBase):
    ...
    def setup(
        ...
        if (
            ...
            return False, "Failed to validate redis stream info"
    ...
    def read_pending_message(
        ...
        Args:
            ...
            blocking_duration_ms (Union[int, None], optional): Number of milliseconds for blocking call. Defaults to None.
    ...
    def send_message_acknowledgement(self, message_id: str) -> bool:
        ...
        Returns:
            bool: True if success, False if failed
        """
        if not self._is_setup_completed or message_id is None or message_id == "":
            return False
        else:
